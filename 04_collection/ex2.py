...
result2=ori.copy()
result2[0].append(100)                  # 원본도 같이 바뀜
...
for subject,score in zip(subjects,scores,strict=False):
    print(f"{subject}: {score}점")

# [X] : X 자체를 원소 하나로 해서 리스트에서 넣음
print([zip(subjects,scores)])
...
result = [sum(i)/len(i) for i in zip(std1,std2,std3)]
